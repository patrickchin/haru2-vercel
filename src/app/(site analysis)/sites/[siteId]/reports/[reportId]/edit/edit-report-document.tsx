        ...
        <Form {...form}>
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      ...
                      <FormItem className="mt-2">
                        <FormControl>
                          <Textarea
                            ...
                            placeholder="Type here name and quantity of materials used. Press Enter to go to next line"
                            autoResize={true}
                          />
                        </FormControl>
                      </FormItem>
              ...
              <div>
                <div className="rounded border p-4 bg-background space-y-2">
                  <h3 className="font-semibold">Equipment Used</h3>
                  <FormField
                    control={form.control}
                    name="equiptment"
                    render={({ field }) => (
                      <FormItem className="mt-2">
                        <FormControl>
                          <Textarea
                            ...
                            value={field.value ?? undefined}
                            className="min-h-40 h-40"
                            placeholder="Type here name and quantity of equipment used. Press Enter to go to next line"
                            autoResize={true}
                          />
                        </FormControl>
                      </FormItem>
