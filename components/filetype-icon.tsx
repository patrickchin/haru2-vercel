import { LucideFile, LucideFileAxis3D, LucideFileImage, LucideFileText, LucideProps } from "lucide-react";

export default function FileTypeToIcon({ type, ...props } : { type: string } & LucideProps) {
