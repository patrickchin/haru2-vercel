        ...
        <div>
          <TabsList className="shadow-sm">
            <TabsTrigger value="description">
              <Link href={{ query: { tab: "description" } }} scroll={false} replace={true}>
                Description
              </Link>
            </TabsTrigger>
            <TabsTrigger
            ...
            >
              <Link href={{ query: { tab: "teams-progress" } }} scroll={false} replace={true}>
                Teams Progress
              </Link>
            </TabsTrigger>
            <TabsTrigger
              ...
              className="disabled:cursor-not-allowed"
            >
              <Link href={{ query: { tab: "task-details" } }} scroll={false} replace={true}>
                Task Details
              </Link>
            </TabsTrigger>
            <TabsTrigger value="files">
              <Link href={{ query: { tab: "files" } }} scroll={false} replace={true}>
                All Files
              </Link>
            </TabsTrigger>
            <TabsTrigger value="model">
              <Link href={{ query: { tab: "model" } }} scroll={false} replace={true}>
                Model View
              </Link>
            </TabsTrigger>
            <TabsTrigger value="settings">
              <Link href={{ query: { tab: "settings" } }} scroll={false} replace={true}>
                Settings
              </Link>
            </TabsTrigger>
          </TabsList>
